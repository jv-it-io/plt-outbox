...
import be.fgov.famhp.plato.outbox.domain.PersistentAuditEvent;
import be.fgov.famhp.plato.outbox.repository.PersistenceAuditEventRepository;
...
@WithMockUser(authorities = {AuthoritiesConstants.ADMIN, FaggAuthoritiesConstants.REGISTRY_ADMIN})
